...
// We need a filtered version of the runners array, containing only those runners with large sized shirts so they can choose a different size. This will be an array of objects.
...
let ticketPriceTotal = runners.reduce((accumulator, runner) => {
  console.log(accumulator, runner.donation);
